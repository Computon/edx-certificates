...
class CertificateGen:
    ...
    def __init__(self, course_id, template_pdf=None, aws_id=None, aws_key=None,
        ...
        try:
            ...
            log.critical(f"Unable to lookup long names for course {course_id}")
            raise
        ...
        try:
            ...
            log.critical(f"I/O error ({e.errno}): {e.strerror} opening {template_pdf_filename}")
            raise
                    ...
                    for filename in filenames:
                        ...
                        if upload:
                            try:
                                ...
                                log.info(f"uploaded {local_path} to {dest_path}")
                        ...
                        if copy_to_webroot:
                            try:
                                ...
                                log.info(f"published {local_path} to {publish_dest}")
